...
// Produce @1x images
gulp.task('images-responsive-1x', async function() {
	return gulp.src('app/images/_src/**/*.{png,jpg,jpeg,webp,raw}')
...
// Produce @2x images
gulp.task('images-responsive-2x', async function() {
	return gulp.src('app/images/_src/**/*.{png,jpg,jpeg,webp,raw}')
...
gulp.task('img', gulp.series('images-responsive-1x', 'images-responsive-2x', bsReload));
...
gulp.task('watch', function() {
	...
	gulp.watch('app/images/_src/**/*', gulp.parallel('img'));
});
