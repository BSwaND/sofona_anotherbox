...
$document->addStyleSheet(JURI::base().'modules/mod_jshopping_cart_wl_ajax/assets/css/default.css');
if ($include_font=="1"){
...
$document->addScript(JURI::base().'modules/mod_jshopping_cart_wl_ajax/assets/js/ajax.js','text/javascript', true, false);
