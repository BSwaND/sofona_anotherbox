...
public static function ajaxDataInCArt($jshopConfig, $controller, $del_sef, $lang, $bsv, $dcount, $tseparator, $module, $document, $obj_postfix, $iclass_ok, $minpriceorder, $maxpriceorder){
	...
	"data_minpotxt":"'.sprintf(_JSHOP_ERROR_MIN_SUM_ORDER, formatprice($minpriceorder)).'",
	"data_maxpotxt":"'.sprintf(_JSHOP_ERROR_MAX_SUM_ORDER, formatprice($maxpriceorder)).'"
	};
